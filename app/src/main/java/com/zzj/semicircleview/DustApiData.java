...
/**
 * Created by JY on 2018-02-25.
 */

public class DustApiData{//CityResponse

        //public @SerializedName("list") ArrayList<List> list;
     public   List<Lists> list;//public List<Geoname> geonames;
}
 class Lists {
    String returnType;
    String coGrade;
